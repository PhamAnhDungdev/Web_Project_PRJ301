...
<html lang="en">
    ...
    <%
        ...
        List<Feedback> listf = (List<Feedback>) u.getAllFeedback();
    %>
    <body>
        ...
        <div class="container">
            ...
            <div class="main-content">
                <div class="table-container">
                    <h2>Bảng quản lý đánh giá của khách hàng</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <tr>
                                <td><%=listf.get(i).getId()%></td>
                                <td><%=listf.get(i).getProductID()%></td>
                                <td><%=listf.get(i).getName()%></td> 
                                <td><%=listf.get(i).getEmail()%></td> 
                                <td><%=listf.get(i).getDatereview()%></td> 
                                <td><%=listf.get(i).getReview()%></td> 
                            </tr
                        </tbody>
                        <%}%>
                    </table>
