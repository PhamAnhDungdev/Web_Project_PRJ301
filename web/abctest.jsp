...
<html lang="en">
    ...
    <%
        ...
        if(x != null){
            ...
            listcart = (List<CartItem>) cart.getListCartItem();
        }else{
            listp = null;
            listcart = null;
        }
                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                         ...
                         <%}%>
                        <%}else{%>
                            <h2>Giỏ hàng trống. Quay lại cửa hàng để thêm sản phẩm!</h2> </br>
                        <%}%>
                    </tbody>
                </table>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Chi tiết</a>
