            ...
            <div class="main-content">
                <div class="table-container">
                    ...
                    <form action="updateproducts" method="POST">
                        ...
                        Tên: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" value="<%=p.getName()%>" name="name"/> </br> </br>

                        Giá: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" value="<%=p.getPrice()%>" name="price"/> </br> </br>

                        Tiêu đề:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" value="<%=p.getTitle()%>" name="title"/> </br> </br>

                        Mô tả: &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" value="<%=p.getDescribe()%>" name="describe"/> </br> </br>

                        <label for="fileInput">
                            Hình ảnh: &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                            <input style="width: 200px; height: 25px" type="file" id="fileInput" value="<%=p.getImage()%>" name="image"/></label></br> </br>

                        Ngày đăng kí: <input readonly type="text" value="<%=p.getDate()%>" name="regisdate"/> </br> </br>

                        Thể loại: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select style="width: 170px; height: 25px;" name="cate"> 
                            <% for(Categories x: listc) { %>
                            <option checked value="<%=x.getId()%>"><%=x.getName()%></option>
                            <% } %>
                        </select></br> </br>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input style="witdh: 200px; height: 30px; font-size: 20px" type="submit" value="Cập nhật"/>
                    </form>
                    </br> </br> 
