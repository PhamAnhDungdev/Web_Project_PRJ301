...
//            x = (User) session.getAttribute("account");//get info user bằng session
//        }else{
//            x = (User) request.getAttribute("user");
//        }
         HttpSession sess = request.getSession();
        User x = (User) sess.getAttribute("account");//get info user bằng session// thông tin ban đầu
        
//        UserDAO ud = new UserDAO();
//        User userupdate = (User) ud.getUserById(x.getId());
//        User userupdate = null;//thông tin sau khi đã update để confirm
//        if(request.getAttribute("user") != null){
//            userupdate = (User) request.getAttribute("user");
//        }else{
//            userupdate = (User) session.getAttribute("account");
//        }
    ...
    <body>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <button class="dropdown-item" type="button"><a href="login.jsp" class="dropdown-item">Xem tài khoản</a></button>
            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        ...
                        <a class="breadcrumb-item text-dark" href="profile.jsp">Thông tin cá nhân</a>
        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                <div class="col-lg-8">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Cập nhật thông tin</span></h5>
                        ...
                        <form action="updateprofile" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" type="text" name="username" readonly value="<%=x.getUsername()%>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Password</label>
                                    <input class="form-control" type="text" name="password" value="<%=x.getPassword()%>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Địa chỉ</label>
                ...
                <div class="col-lg-4">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Thông tin ban đầu</span></h5>
                    <div class="bg-light p-30 mb-5">
                        <div class="border-bottom">
                            <h6 class="mb-3">Xác nhận thông tin </h6>  
                        ...
                        <div class="border-bottom pt-3 pb-2">
                            <div class="d-flex justify-content-between mb-3">
                                <h6 class="font-weight-medium">Họ:</h6>
                                <h6><%=x.getFirstname()%></h6>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                <h6 class="font-weight-medium">Tài khoản:</h6>
                                <h6><%=x.getUsername()%></h6>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                                <h6 class="font-weight-medium">Mật khẩu:</h6>
                                <h6><%=x.getPassword()%></h6>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                            ...
                            <button type="submit" class="btn btn-block btn-primary font-weight-bold py-3"><a style="color: black; text-decoration: none" href="home.jsp">Xác nhận</a></button>
                        </div>  
                    </div> 
                </div>
            </div>
