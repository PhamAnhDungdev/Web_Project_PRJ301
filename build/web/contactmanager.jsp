...
<html lang="en">
    ...
    <%
        ContactDAO u = new ContactDAO();
        List<Contact> listc = (List<Contact>) u.getAllContact();
    %>
    <body>
        ...
        <div class="container">
            ...
            <div class="main-content">
                <div class="table-container">
                    <h2>Bảng quản lý liên hệ của khách hàng</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=listc.get(i).getTitle()%></td> 
                                <td><%=listc.get(i).getEmail()%></td> 
                                <td><%=listc.get(i).getMessage()%></td> 
                            </tr>
                        </tbody>
                        <%}%>
                    </table>
