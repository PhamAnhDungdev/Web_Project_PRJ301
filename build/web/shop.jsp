<%-- 
    Document   : shop
    Created on : Feb 24, 2024, 5:29:18 PM
    Author     : Bravo 15
--%>
...
<html lang="en">
    ...
    <%
        CategoriesDAO c = new CategoriesDAO();//get list categories từ database
        List<Categories> listc = (List<Categories>) c.getListCategories();
        
        ProductsDAO u = new ProductsDAO();
        List<Products> list = null;
        if(request.getAttribute("list")==null){
            list = (List<Products>) u.getAllProducts();
        }else{
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="shop.jsp" class="nav-item nav-link active">Cửa hàng</a>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                <!-- Price Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Lọc theo khoảng giá</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form action="filter" method="GET">
                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-all" value="1" name="price-option">
                            <label class="custom-control-label" for="price-all">0 - 2</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>

                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-1" value="2" name="price-option">
                            <label class="custom-control-label" for="price-1">2 - 4</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>

                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-2" value="3" name="price-option">
                            <label class="custom-control-label" for="price-2">4 - 8</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>

                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-3" value="4" name="price-option">
                            <label class="custom-control-label" for="price-3">8 - 10</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>

                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-4" value="5" name="price-option">
                            <label class="custom-control-label" for="price-4">10 - 15</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>
                        <div class="custom-control custom-radio d-flex align-items-center justify-content-between mb-3">
                            <input type="radio" class="custom-control-input" id="price-5" value="6" name="price-option">
                            <label class="custom-control-label" for="price-5">15 - 25</label>
                            <span class="badge border font-weight-normal">Triệu VNĐ</span>
                        </div>
                        <select style="width: 100px; height: 25px; border: none" name="order">
                            <option value="1">Tăng dần</option>
                            <option value="2">Giảm dần</option>
                        </select>
                        <input type="hidden" value="${param.id}" name="cid"/> <!--lấy cate id-->
                        <input style="background-color: #FFD333; border: 1px;" type="submit" value="Lọc sản phẩm" />
                    </form>
                </div>
                <!-- Price End -->
                ...
                <div class="bg-light p-4 mb-30">
                    <form action="filter2" method="GET">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="size-all" name="min" placeholder="Từ">
                        </div>
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="size-all" name="max" placeholder="Đến">
                        </div>
                        <select style="width: 100px; height: 25px; border: none" name="order">
                            <option value="1">Tăng dần</option>
                            <option value="2">Giảm dần</option>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="sortshopasc?id=${param.id}">Tăng dần</a>
                                        <a class="dropdown-item" href="sortshopdesc?id=${param.id}">Giảm dần</a>
                                    </div>
                                </div>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="favouriteinsert?id=<%=list.get(i).getId()%>"><i class="far fa-heart"></i></a>
