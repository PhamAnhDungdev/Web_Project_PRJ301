        ...
        <div class="container">
            ...
            <div class="main-content">
                <div class="table-container">
                    <h2>Cập nhật thể loại sản phẩm</h2>
                    <form action="updatecategories" method="POST">
                        <input style="display: none" readonly type="text" name="id" value="<%=cate.getId()%>" />
                        Thể loại cũ: <input style="witdh: 300px; height: 20px" readonly type="text" value="<%=cate.getName()%>" placeholder="Nhập tên thể loại"/> </br> </br>
                        Thể loại mới: <input style="witdh: 300px; height: 20px" type="text" name="name" placeholder="Nhập tên thể loại"/> </br> </br>
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
