...
<html lang="en">
    ...
    <%
        ...
        List<Orders> listo = (List<Orders>) u.getAllOrders();
    %>
    <body>
        <div class="header">
        ...
        <div class="container">
            ...
            <div class="main-content">
                <div class="table-container">
                    <h2>Bảng quản lí danh sách đơn hàng</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=listo.get(i).getFirstName()%> <%=listo.get(i).getLastName()%></td>
                                <td><%=listo.get(i).getPhone()%></td>
                                <td><%=listo.get(i).getEmail()%></td>
                                <td><%=listo.get(i).getAddress()%></td>
                                <td><%=listo.get(i).getCountry()%></td>
                                <td><%=listo.get(i).getOrderDate()%></td>
                                <td><%=listo.get(i).getTotalamout()%></td>
                                <td>
                                    <button><a style="text-decoration: none" href="orderdetail?id=<%=listo.get(i).getOrderID()%>">Xem chi tiết</a></button>
                                </td>
                            </tr>
                        </tbody>
                        <%}%>
