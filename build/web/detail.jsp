<%-- 
    Document   : detail
    Created on : Feb 24, 2024, 5:31:11 PM
    Author     : Bravo 15
--%>
...
<html lang="en">
    ...
    <%
        ...
        Products pd = (Products) request.getAttribute("productdetail");
        //get all product
        ProductsDAO u = new ProductsDAO();//phần mục sản phẩm có thể bạn sẽ thích
        List<Products> list = (List<Products>) u.getAllProducts();
        
        //get thông báo fb đã gửi hoặc chưa gửi
        String thongbao = (String) request.getAttribute("thongbao");
        
        FeedbackDAO f = new FeedbackDAO();
        List<Feedback> listfb = null;
        if(request.getAttribute("listfb") == null){
            listfb = f.getFeedbackByPid(pd.getId());
        }else{
            listfb = (List<Feedback>) request.getAttribute("listfb");
        }
        //List<Feedback> listfb = (List<Feedback>) request.getAttribute("listfb");
    %>
    <body>
        <!-- Topbar Start -->
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <!--<a href="detail.jsp" class="nav-item nav-link active">Chi tiết</a>-->
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="image/<%=pd.getImage()%>" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><%=pd.getPrice()%></h3>
                    <p class="mb-4"><%=pd.getDescribe()%></p>
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <form action="addtocart" method="GET">
                            <div class="quantity mr-3" style="width: 130px;">
                                <div class="input-group-btn">
                                    <input class="quantity-btn btn-minus" type="text" name="id" value="<%=pd.getId()%>" style="display: none" readonly/>
                                    Số lượng <input type="number" name="quantity" class="quantity-btn btn-minus" min="1" max="50"/>
                                </div>
                            </div> 
                            </br>
                            <!--<input type="submit" value="Thêm vào giỏ" class="btn btn-primary px-3" />-->
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <p><%=pd.getTitle()%></p>
                            <p><%=pd.getDescribe()%> Các sản phẩm từ làng nghề truyền thống TRỐNG ĐỌI TAM luôn được đánh giá là có chất lượng hàng đầu cả nước.
                                Trống da trâu gỗ mít, xe ngựa kéo pháo đựng rượu, 
                                thùng gỗ sồi ngâm rượu chất lượng... Mỗi năm, các sản phẩm của chúng tôi đã xuất đi có thể tính tới hàng ngàn chiếc.</p>
                        </div>

                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">Đánh giá tiêu biểu</h4>
                                    <%for(int i = 0; i< listfb.size(); i++){%>
                                    <div class="media mb-4">
                                        <img src="image/userfeedback.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6><%=listfb.get(i).getName()%><small> - <i><%=listfb.get(i).getDatereview()%></i></small></h6>
                                            <p><%=listfb.get(i).getReview()%></p>
                                        </div>
                                    </div>
                                    <%}%>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <small>(Địa chỉ email của bạn sẽ được bảo mật tuyệt đối)</small> </br>
                                    <form action="insertfeedback" method="GET">
                                        ...
                                        <input type="hidden" value="<%=pd.getId()%>" name="pid"/> <!--lấy product id từ url-->
                                        ...
                                        <h4><%=thongbao%></h4>
                                        <%}else{%>
                                        <h4 style="display: none"><%=thongbao%></h4>
                                        <%}%>
                                    </form>
                                </div>
                            </div>
