        ...
        <div class="container">
            <nav class="sidebar">
                <ul>
                    ...
                    <li><a href="managerfeedback.jsp">Feedback của khách hàng</a></li>
            ...
            <div class="main-content">
                <div class="table-container">
                    <h2>Thêm mới thể loại sản phẩm</h2>
                    <form action="addcategories" method="GET">
                        Nhập tên: <input style="witdh: 300px; height: 20px" type="text" name="name" placeholder="Nhập tên thể loại"/> </br> </br>
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input style="witdh: 200px; height: 30px; font-size: 20px" type="submit" value="Thêm"/>
                    </form>                
                </div>
                <c:choose>
                ...
                <div class="table-container">
                    <h2>Bảng quản lí danh sách thể loại sản phẩm</h2>
                    <table>
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <tr>
                                <td><%=listc.get(i).getId()%></td>
                                <td><%=listc.get(i).getName()%></td>
                                <td>
                                    <button><a style="text-decoration: none" href="updatecategories?id=<%=listc.get(i).getId()%>">Cập nhật</a></button>
                                    <button><a style="text-decoration: none" href="deletecategories?id=<%=listc.get(i).getId()%>">Xóa </a></button>
                                </td>
                            </tr>
                        </tbody>
                        <%}%>
